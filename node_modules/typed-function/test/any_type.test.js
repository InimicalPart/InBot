...
describe('any type', function () {
  ...
  it('should compose a function with multiple any type arguments (1)', function () {
    ...
    assert.throws(function () {
      fn([], new Date())
    }, /TypeError: Unexpected type of argument in function unnamed \(expected: string or boolean, actual: Date, index: 1\)/);
    assert.throws(function () {
      fn(2, 2)
    }, /TypeError: Unexpected type of argument in function unnamed \(expected: string or boolean, actual: number, index: 1\)/);
    assert.throws(function () {
      fn(2)
    }, /TypeError: Too few arguments in function unnamed \(expected: string or boolean, index: 1\)/);
  });
  ...
  it('should compose a function with multiple any type arguments (2)', function () {
    ...
    assert.throws(function () {
      fn([], new Date())
    }, /TypeError: Unexpected type of argument in function unnamed \(expected: number or boolean, actual: Date, index: 1\)/);
    assert.throws(function () {
      fn([], 'foo')
  ...
  it('should compose a function with multiple any type arguments (3)', function () {
    ...
    assert.throws(function () {
      fn()
    }, /TypeError: Too few arguments in function unnamed \(expected: any, index: 0\)/);
    assert.throws(function () {
      fn([], 'foo')
    }, /TypeError: Too many arguments in function unnamed \(expected: 1, actual: 2\)/);
    assert.throws(function () {
      fn('foo', 4, [])
  ...
  it('should compose a function with multiple any type arguments (4)', function () {
    ...
    assert.throws(function () {
      fn('foo')
    }, /TypeError: Too few arguments in function fn1 \(expected: string, index: 1\)/);
    assert.throws(function () {
      fn(1, 2, 3)
    }, /TypeError: Too many arguments in function fn1 \(expected: 2, actual: 3\)/);
  });
  ...
  it('should compose a function with multiple any type arguments (5)', function () {
    ...
    assert.throws(function () {
      fn('foo', 2, 5)
    }, /TypeError: Unexpected type of argument in function unnamed \(expected: string, actual: number, index: 1\)/);
    assert.throws(function () {
      fn('foo', 'bar', 5)
    }, /TypeError: Too many arguments in function unnamed \(expected: 2, actual: 3\)/);
  });
  ...
  it('should permit multi-layered use of any', function () {
    ...
    assert.throws(function () {
      fn(1, 1, 1)
    }, /TypeError: Unexpected type of argument in function unnamed \(expected: string, actual: number, index: 2\)/);
  });
