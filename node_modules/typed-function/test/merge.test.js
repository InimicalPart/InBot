...
describe('merge', function () {
  ...
  it('should merge three typed-functions', function () {
    ...
    assert.throws(function () {
      typed4(new Date())
    }, /TypeError: Unexpected type of argument in function unnamed \(expected: number or string or boolean, actual: Date, index: 0\)/);
  });

  it('should merge two typed-functions with a custom name', function () {
    var typed1 = typed('typed1', {
      'boolean': function (value) {
        return 'boolean:' + value;
      }
    });
    var typed2 = typed('typed2', {
      'number': function (value) {
        return 'number:' + value;
      }
    });
  ...
  it('should not copy conversions as exact signatures', function () {
    ...
    assert.throws(function () {
      fn3('123')
    }, /TypeError: Unexpected type of argument in function unnamed \(expected: number or Date, actual: string, index: 0\)/);
  });
  ...
  it('should throw an error in case of conflicting names when merging', function () {
    var typed1 = typed('fn1', {
      'boolean': function () {}
    });
    var typed2 = typed('fn2', {
      'string': function () {}
    });
    var typed3 = typed({
      'number': function () {}
