...
describe('rest parameters', function () {
  ...
  it('should create a typed function with rest parameters', function () {
    ...
    assert.throws(function () {
      sum()
    }, /TypeError: Too few arguments in function unnamed \(expected: number, index: 0\)/);
    assert.throws(function () {
      sum(true)
    }, /TypeError: Unexpected type of argument in function unnamed \(expected: number, actual: boolean, index: 0\)/);
    assert.throws(function () {
      sum('string')
    }, /TypeError: Unexpected type of argument in function unnamed \(expected: number, actual: string, index: 0\)/);
    assert.throws(function () {
      sum(2, 'string')
    }, /TypeError: Unexpected type of argument in function unnamed \(expected: number, actual: string, index: 1\)/);
    assert.throws(function () {
      sum(2, 3, 'string')
    }, /TypeError: Unexpected type of argument in function unnamed \(expected: number, actual: string, index: 2\)/);
  });
  ...
  it('should create a typed function with rest parameters (2)', function () {
    ...
    assert.throws(function () {
      fn(2, 4)
    }, /TypeError: Unexpected type of argument in function unnamed \(expected: string, actual: number, index: 0\)/);
    assert.throws(function () {
      fn('string')
    }, /TypeError: Too few arguments in function unnamed \(expected: number, index: 1\)/);
    assert.throws(function () {
      fn('string', 'string')
    }, /TypeError: Unexpected type of argument in function unnamed \(expected: number, actual: string, index: 1\)/);
  });
  ...
  it('should create a typed function with any type arguments (1)', function () {
    ...
    assert.throws(function () {
      fn('string')
    }, /TypeError: Too few arguments in function unnamed \(expected: any, index: 1\)/);
  });
  ...
  it('should create a typed function with union type arguments', function () {
    ...
    assert.throws(function () {
      fn()
    }, /TypeError: Too few arguments in function unnamed \(expected: number or string, index: 0\)/);
    assert.throws(function () {
      fn('string', true)
    }, /TypeError: Unexpected type of argument. Index: 1 in function unnamed \(expected: string | number/);
    assert.throws(function () {
      fn(2, false)
    }, /TypeError: Unexpected type of argument. Index: 1 in function unnamed \(expected: string | number/);
    assert.throws(function () {
      fn(2, 3, false)
    }, /TypeError: Unexpected type of argument. Index: 2 in function unnamed \(expected: string | number/);
  });
  ...
  it('should create a composed function with rest parameters', function () {
    ...
    assert.throws(function () {
      fn(2, 4)
    }, /TypeError: Unexpected type of argument in function unnamed \(expected: string or boolean, actual: number, index: 0\)/);
    assert.throws(function () {
      fn('string')
    }, /TypeError: Too few arguments in function unnamed \(expected: number, index: 1\)/);
    assert.throws(function () {
