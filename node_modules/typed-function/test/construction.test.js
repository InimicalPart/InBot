...
describe('construction', function () {
  ...
  it('should throw an error when providing an unsupported type of argument', function () {
    ...
    assert.throws(function () {
      fn(new Date())
    }, /TypeError: Unexpected type of argument in function fn1 \(expected: number, actual: Date, index: 0\)/);
  });
  ...
  it('should throw an error when providing a wrong function signature', function () {
    ...
    assert.throws(function () {
      fn(1, 2)
    }, /TypeError: Too many arguments in function fn1 \(expected: 1, actual: 2\)/);
  });
