...
function createUnoDeck() {
    ...
    */
    ...
    deck.push.apply(deck, createCards(4, card_1.Values.WILD));
    deck.push.apply(deck, createCards(4, card_1.Values.WILD_DRAW_FOUR));
    return deck;
}
var Deck = /** @class */ (function () {
    ...
    Object.defineProperty(Deck.prototype, "discardedPile", {
        get: function () {
    ...
    Deck.prototype.reshuffle = function () {
        this.shuffle = shuffle_1.shuffle({ deck: this.discarded });
    };
