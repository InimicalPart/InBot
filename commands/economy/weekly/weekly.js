...
async function runCommand(message, args, RM) {
  ...
  if (!require(RM.path.resolve(global.dirName, "config.js")).cmdWeekly) {
  ...
  message.channel
    ...
    .then(async (m) => {
      ...
      await connect.updateCooldown(
        ...
        undefined,
        new Date(
          new Date().setTime(new Date().getTime() + 168 * 60 * 60 * 1000)
        )
      );
      ...
      m.edit({
        embeds: [
          new RM.Discord.MessageEmbed()
            ...
            .setDescription("**Success:** You have been given $30,000!")
            .setThumbnail(message.guild.iconURL())
            .setTitle("Success"),
        ],
      });
