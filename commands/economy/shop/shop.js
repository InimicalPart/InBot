const commandInfo = {
  ...
  possibleTriggers: ["shop"], // These are all commands that will trigger this command.
  help: "Shows all the items that you can buy", // This is the general description of the command.
