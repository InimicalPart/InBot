const commandInfo = {
  ...
  possibleTriggers: ["buy"], // These are all commands that will trigger this command.
  help: "Buy an item from `[PREFIX]shop`", // This is the general description of the command.
