const commandInfo = {
  primaryName: "warn", // This is the command name used by help.js (gets uppercased).
  possibleTriggers: ["warn", "alias2", "alias3"], // These are all commands that will trigger this command.
