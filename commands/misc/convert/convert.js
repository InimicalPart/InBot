...
const DateFormatter = { monthNames: ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"], dayNames: ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"], formatDate: function (e, t) { var r = this; return t = r.getProperDigits(t, /d+/gi, e.getUTCDate()), t = (t = r.getProperDigits(t, /M+/g, e.getUTCMonth() + 1)).replace(/y+/gi, function (t) { var r = t.length, g = e.getUTCFullYear(); return 2 == r ? (g + "").slice(-2) : 4 == r ? g : t }), t = r.getProperDigits(t, /H+/g, e.getUTCHours()), t = r.getProperDigits(t, /h+/g, r.getHours12(e.getUTCHours())), t = r.getProperDigits(t, /m+/g, e.getUTCMinutes()), t = (t = r.getProperDigits(t, /s+/gi, e.getUTCSeconds())).replace(/a/gi, function (t) { var g = r.getAmPm(e.getUTCHours()); return "A" === t ? g.toUpperCase() : g }), t = r.getFullOr3Letters(t, /d+/gi, r.dayNames, e.getUTCDay()), t = r.getFullOr3Letters(t, /M+/g, r.monthNames, e.getUTCMonth()) }, getProperDigits: function (e, t, r) { return e.replace(t, function (e) { var t = e.length; return 1 == t ? r : 2 == t ? ("0" + r).slice(-2) : e }) }, getHours12: function (e) { return (e + 24) % 12 || 12 }, getAmPm: function (e) { return e >= 12 ? "pm" : "am" }, getFullOr3Letters: function (e, t, r, g) { return e.replace(t, function (e) { var t = e.length; return 3 == t ? r[g].substr(0, 3) : 4 == t ? r[g] : e }) } };
async function runCommand(message, args, RM) {
	...
	if (!args[0]) {
		return message.channel.send(new RM.Discord.MessageEmbed()
			...
			.setAuthor(message.author.tag, message.author.avatarURL())
			.setDescription(
				"You need to specify the type to convert."
			)
			.setThumbnail(message.guild.iconURL())
	...
	if (!args[1]) {
		return message.channel.send(new RM.Discord.MessageEmbed()
			...
			.setAuthor(message.author.tag, message.author.avatarURL())
			.setDescription(
				"You need to specify the value to convert."
			)
			.setThumbnail(message.guild.iconURL())
	...
	switch (args[0].toLowerCase()) {
		...
		case "epochd":
			...
			break;
		case "epoch":
			result = DateFormatter.formatDate(new Date(value), `MMMM ????, YYYY HH:mm:ss A UTC`);
			result = result.replace("????", getOrdinalNum(new Date(value).getUTCDate()))
			break;
		default:
			return message.channel.send(new RM.Discord.MessageEmbed()
				.setColor("RED")
