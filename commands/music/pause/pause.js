const commandInfo = {
  primaryName: "pause", // This is the command name used by help.js (gets uppercased).
  possibleTriggers: ["pause"], // These are all commands that will trigger this command.
  help: "Pause the player", // This is the general description of the command.
