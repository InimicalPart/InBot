const commandInfo = {
  primaryName: "resume", // This is the command name used by help.js (gets uppercased).
  possibleTriggers: ["resume"], // These are all commands that will trigger this command.
  help: "Resume the player", // This is the general description of the command.
