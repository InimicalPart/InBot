...
try {
    ...
    const {
        connect
    } = require(path.resolve(global.dirName, "databasec.js"));
    (async () => {
        await connect();
    })();
    ...
    client.on("ready", async () => {
        ...
        isDevMode =
        edition === "DEVELOPMENT"
        ? chalk.greenBright("YES"): chalk.redBright("NO");
        console.log(
            "------------------------\n" +
            "Current time is: " +
            ...
            " ms\n" +
            "Prefix: " + chalk.blue(process.env.prefix)
            + "\n" +
            "------------------------\n" +
