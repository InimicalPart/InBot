...
const cmdMotivation = require('./commands/motivation/motivation.js')
//-------------------------------------------
...
client.on('message', async (message) => {
  ...
  if (!message.content.startsWith(prefix)) return;
	...
	} else if (cmdMotivation.commandAlias().includes(command)) {
		cmdMotivation.runCommand(message, args, requiredModules)
	}
