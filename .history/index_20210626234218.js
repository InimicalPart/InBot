	...
	if (message.content.startsWith(prefix + "test")) {
		if (botOwners.includes(message.author.id)) {
			message.channel.send("alr pinging...").then (async (msg) =>{
				msg.delete()
				message.channel.send(`<:Eboy:841673408138707005> latency is ${msg.createdTimestamp - message.createdTimestamp}ms. and API latency is ${Math.round(client.ws.ping)}ms`);
			})
		} else {
